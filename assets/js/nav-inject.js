...
<footer id="footer">
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    import('/assets/js/supabase.js?v=769a23b7').then(async ({ getNavMenu }) => {
      try {
    ...
    if (newsletterBtn && newsletterInput) {
      newsletterBtn.addEventListener('click', async () => {
        ...
        try {
          const { subscribeToNewsletter } = await import('/assets/js/supabase.js?v=769a23b7');
    ...
    if (partnersMount) {
      import('/assets/js/supabase.js?v=769a23b7').then(async ({ getPartners }) => {
        try {
